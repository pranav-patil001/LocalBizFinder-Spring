...
<head>
  ...
  <title>Explore All Businesses - Owner Dashboard</title>
...
<body>
  ...
  <div class="main-content">
    <h2>Explore All Approved Businesses</h2>
    <%
        List<BusinessOwner> allBusiness = (List<BusinessOwner>) request.getAttribute("allBusiness");
    ...
    <table>
      ...
      <%
        for (BusinessOwner b : allBusiness) {
          if ("Approved".equals(b.getBusinessStatus())) {
      %>
      <tr>
        ...
        <td><a href="ViewAllBusinessReviews?contact=<%= b.getOwnerContact() %>">View</a></td>
      </tr>
      <%
          }
        }
