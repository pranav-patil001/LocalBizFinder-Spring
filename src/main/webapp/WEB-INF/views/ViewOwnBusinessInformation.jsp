...
<head>
  ...
  <title>View Business Info - Owner Dashboard</title>
...
<body>
  ...
  <div class="main-content">
    <h2>View Own Business Information</h2>
    <%
        BusinessOwner businessOwner = (BusinessOwner) request.getAttribute("businessOwner");
    ...
    <table>
      ...
      <tr>
        <td><%= businessOwner.getBusinessName() %></td>
        <td><%= businessOwner.getBusinessCategory() %></td>
        <td><%= businessOwner.getBusinessAddress() %></td>
        <td><%= businessOwner.getOwnerName() %></td>
        <td><%= businessOwner.getOwnerContact() %></td>
      </tr>
    </table>
    <a href="UpdateOwnBusinessInformation" class="update-btn">Update Information</a>
    <% } else { %>
