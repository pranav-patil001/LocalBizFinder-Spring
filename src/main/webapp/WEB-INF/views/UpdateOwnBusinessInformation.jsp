...
<head>
  ...
  <title>Update Business Info - Owner Dashboard</title>
...
<body>
  ...
  <div class="main-content">
    <form class="form-box" action="UpdateOwnBusinessInfoSubmit" method="post">
      <h2>Update Own Business Information</h2>
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" name="ownerCity" required>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" name="businessCategory" required>
        </div>

        <div class="form-group">
          <label for="businessDescription">Business Description:</label>
          <textarea name="businessDescription" rows="4" required></textarea>
        </div>

        <div class="form-group">
          <label for="businessAddress">Business Address:</label>
          <textarea name="businessAddress" rows="3" required></textarea>
        </div>
      </div>
